...
```{r}
experiment_slug <- "2023-10-11-test"
...
# Palette
scale_fill_fun <- scale_fill_viridis_d
scale_color_fun <- scale_color_viridis_d
alpha <- 0.05
...
ggsave(
  ...
  filename=paste0(plot_directory, "2023-10-11-best-pop-task-cov-ts.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  filename=paste0(plot_directory, "2023-10-11-best-pop-task-cov-ts-early.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  ...
  paste0(plot_directory, "2023-10-11-metapop-task-cov.pdf")
)
```
...
ggsave(
  ...
  filename=paste0(plot_directory, "2023-10-11-metapop-task-cov-ts.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  filename=paste0(plot_directory, "2023-10-11-metapop-task-cov-ts-early.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  ...
  paste0(plot_directory, "2023-10-11-num-task-profiles.pdf")
)
```
...
ggsave(
  num_task_profiles_ot_fig,
  filename=paste0(plot_directory, "2023-10-11-num-task-profiles-ts.png"),
  width=10,
  height=6
)
```
...
ggsave(
  ...
  paste0(plot_directory, "2023-10-11-task-profile-spread.pdf")
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-task-profile-entropy.pdf")
)
```
...
ggsave(
  filename=paste0(plot_directory, "2023-10-11-pop-trait-profile-entropy-ts.png"),
  width=10,
  height=6
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-task-cov-per-n-pops.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-task-cov-per-n-pops-alt.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-num-selected.pdf")
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-num-orgs.pdf")
)
```
...
ggsave(
  paste0(plot_directory, "2023-10-11-avg-gens.pdf")
)
...
save_plot(
  filename=paste0(plot_directory, "2023-10-11-selection-figure.pdf"),
  plot=grid,
  base_height=5,
  base_asp=2.5,
  dpi=600
...
save_plot(
  filename=paste0(plot_directory, "2023-10-11-selection-figure-with-timeseries.pdf"),
  plot=grid,
  base_width=12,
  base_height=10,
  # base_asp=1.6,
